...
from recbole.model.loss import WithoutIPSDualBCELoss
import numpy as np
...
class IDIUSWOIPS(SequentialRecommender):

    input_type = InputType.POINTWISE

    def __init__(self, config, dataset):
        super(IDIUSWOIPS, self).__init__(config, dataset)
        ...
        self.loss = WithoutIPSDualBCELoss(clip=config['IPS_clip'],max_clip=config['IPS_max_clip'],
    ...
    def calculate_loss(self, interaction):
        ...
        loss = self.loss(preds,label,None,None)
